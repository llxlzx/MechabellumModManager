...
SetupAppRunningError=安装程序检测到 %1 当前正在运行。%n%n请先关闭正在运行的程序，然后点击“确定”继续，或点击“取消”退出。%n%n若钢铁指挥官 Mod 管理器正在切换正式服/测试服或安装 MelonLoader，请先在管理器内完成或取消该任务并正常退出，再继续安装。不建议强制结束进程。
...
ApplicationsFound=以下应用程序正在使用将由安装程序更新的文件。%n%n若钢铁指挥官 Mod 管理器正在切换正式服/测试服或安装 MelonLoader，请先在管理器内完成或取消该任务并正常退出，再继续安装。不建议强制结束进程。%n%n若管理器未在执行上述任务，您可以选择允许安装程序自动关闭这些应用程序。
ApplicationsFound2=以下应用程序正在使用将由安装程序更新的文件。%n%n若钢铁指挥官 Mod 管理器正在切换正式服/测试服或安装 MelonLoader，请先在管理器内完成或取消该任务并正常退出，再继续安装。不建议强制结束进程。%n%n若管理器未在执行上述任务，您可以选择允许安装程序自动关闭这些应用程序；安装完成后，安装程序将尝试重新启动它们。您也可以自行关闭相关程序后点击“重试”。
CloseApplications=自动关闭应用程序(&A)
DontCloseApplications=不要关闭应用程序(&D)
ErrorCloseApplications=安装程序无法自动关闭所有应用程序。建议您在继续之前，关闭所有在使用需要由安装程序更新的文件的应用程序。%n%n若钢铁指挥官 Mod 管理器正在切换正式服/测试服或安装 MelonLoader，请先在管理器内完成或取消该任务并正常退出，再继续安装。不建议强制结束进程。
