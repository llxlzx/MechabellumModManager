...
- [x] **Step 6:** Commit：`fix: teardown dual-folder via Official first with Busy`
...
- [x] **Step 5:** Commit：`fix: ensure process exit after confirmed close during Busy`
...
- [x] **Step 5:** Commit：`fix: Melon assembly gen timeout + heartbeat logs`
...
- [x] **Step 5:** Commit：`fix: block Steam settle while update unhealthy`
...
- [x] **Step 6:** Commit：`feat: diagnostics summary + timeline for less tester toil`
...
- [x] **Step 3:** Commit：`docs: v1.1.x dual-folder freeze/teardown/diagnostics notes`
