...
- 署名：院长大人；QQ 319323959；感谢测试者/玩家/Mod 作者；非盈利声明；完整风险与免责（现状提供、第三方风险、官方未必支持、辅助功能非担保、举报/下架权、继续使用即同意）
...
- 设置：语言、署名/感谢/非盈利与风险免责声明
- Mod 浏览 / 库：举报按钮 → 对话框
- 投稿入口：选 dll、填信息、上传（Relay 未配置时 OK 信息提示，非 Yes/No）
