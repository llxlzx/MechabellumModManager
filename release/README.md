...
## 目录结构（以 v1.0.7 为例（当前最新；旧版本仍保留作历史对照））
...
release/
  ...
  v1.0.7/
    安装包/
      MechabellumModManager_Setup_v1.0.7.exe   # 推荐：完整安装程序
    ...
    MechabellumModManager_portable_v1.0.7.zip  # 便携包（本体内容打 zip，解压即 exe+Assets）
```
